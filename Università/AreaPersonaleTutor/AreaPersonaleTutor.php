...
<?php
    if (!empty($_POST["newPw"]) && !empty($_POST["confPw"]) &&!empty($_POST["oldPw"])){
        ...
        $controllo = "SELECT password FROM tutor WHERE CF = '$utente' " ;
        ...
        if(count($error) == 0){
                $query = "UPDATE tutor SET password = '$password' WHERE CF = '$utente' ";
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="AreaPersonaleTutor.css">
...
<body>
    ...
    <div class="Contenitore">
                ...
                <form action="AreaPersonaleTutor.php" name="Password" id="Password" method="POST">
