...
<?php
    if (!empty($_POST["newPw"]) && !empty($_POST["confPw"]) &&!empty($_POST["oldPw"])){
        ...
        $controllo = "SELECT password FROM studente WHERE CF = '$utente' " ;
        ...
        if(count($error) == 0){
                $query = "UPDATE studente SET password = '$password' WHERE CF = '$utente' ";
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="AreaPersonaleStudente.css">
...
<body>
    ...
    <section>
        ...
        <div class="Contenitore">
                ...
                <form action="AreaPersonaleStudente.php" name="Password" id="Password" method="POST">
